...
# ============================
SESSION = environ.get('SESSION', 'New_Line_Movies_Bot')   # Session name for the bot
...
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', LOG_CHANNEL))  # Fallback to LOG_CHANNEL if BIN_CHANNEL is not set
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/newlinemovies')  # Support group link (make sure bot is admin)
...
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'moviebot_files') # Collection name (default: moviebot_files)
...
MOVIEBOT_IMAGE_FETCH = bool(environ.get('MOVIEBOT_IMAGE_FETCH', True))  # On (True) / Off (False)
...
TUTORIAL = environ.get("TUTORIAL", "https://t.me/newlinemovies")   # Tutorial link for verification
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/newlinemovies")   # Second tutorial link for verification
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/newlinemovies")   # Third tutorial link for verification
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/newlinemovies') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/babybudha') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/newlinemovies') # Update channel link for the bot
...
MSG_ALRT = environ.get('MSG_ALRT', 'Newline Movies') # Alert message for users
...
MULTI_CLIENT = False
name = str(environ.get('name', 'MOVIEBOT'))
