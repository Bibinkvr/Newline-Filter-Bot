class script(object):
    START_TXT = """<b>Hi {0} Welcome to {3} 🎬\n\nFind movies fast.\nType the exact name.\nGet direct results in seconds.\n\n<blockquote>No ads. No spam. Only clean access. 🍿</blockquote>\n\n────────────────────\n\nStay updated\n\nJoin the channel for\n• Latest releases\n• OTT arrivals\n• Daily updates</b>"""
...
Mᴇꜱꜱᴀɢᴇ : <b>{}</b>"""
    ...
    CAPTION = """<b><a href="https://t.me/newlinemovies">{file_name}</a></b>\n\n<b>⚜️ Powered By : <a href="https://t.me/newlinemovies">[ ᴍᴏᴠɪᴇʙᴏᴛ ]</a></b>"""
...
<b>ʀᴇǫ ʙʏ : {message.from_user.mention}</b>"""
    ...
    LOGO = r"""
     __  __  ____ __     __ _____  ____   ____  _______ 
    |  \/  |/ __ \\ \   / /|_   _||  _ \ / __ \ |__   __|
    | \  / | |  | |\ \_/ /   | |  | |_) | |  | |   | |   
    | |\/| | |  | | \   /    | |  |  _ <| |  | |   | |   
    | |  | | |__| |  | |    _| |_ | |_) | |__| |   | |   
    ...
    SOURCE_TXT ="""<b>ՏOᑌᖇᑕᗸᗴ ᑕOᗸᗴ : 👇 </b>

This Is An Open-Source Project. You Can Use It Freely, But Selling The Source Code Is Strictly Prohibited.\n
ꜱᴏᴜʀᴄᴇ ᴄᴏᴅᴇ ʜᴇʀᴇ ◉› :<a href=https://github.com/Moviebot/Auto_Filter_Bot.git>𝓜𝓸𝓿𝓲𝓮𝓫𝓸𝓽</a>\n """
